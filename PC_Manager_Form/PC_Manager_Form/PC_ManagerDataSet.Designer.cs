...
namespace PC_Manager_Form {
    ...
    public partial class PC_ManagerDataSet : global::System.Data.DataSet {
        ...
        private void InitClass() {
            ...
            this.Prefix = "";
            this.Namespace = "http://tempuri.org/PC_ManagerDataSet.xsd";
...
namespace PC_Manager_Form.PC_ManagerDataSetTableAdapters {
    ...
    public partial class orderTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[order] ([remark], [pid], [uid], [sid], [final_price], [date], " +
                "[status]) VALUES (@remark, @pid, @uid, @sid, @final_price, @date, @status)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[order] SET [remark] = @remark, [pid] = @pid, [uid] = @uid, [sid] = " +
                "@sid, [final_price] = @final_price, [date] = @date, [status] = @status WHERE (([" +
                "oid] = @Original_oid))";
        ...
        public virtual int Update(string remark, global::System.Nullable<int> pid, string uid, string sid, global::System.Nullable<double> final_price, string date, global::System.Nullable<int> status, int Original_oid) {
            if ((remark == null)) {
